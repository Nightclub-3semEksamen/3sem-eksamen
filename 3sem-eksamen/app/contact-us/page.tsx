      ...
      <section className="px-6 py-10 md:py-20 flex justify-center bg-[oklch(0.05_0_0)]">
        <form onSubmit={handleSubmit} className="w-full max-w-[650px]">
          <input
            ...
            className="w-full h-[54px] md:h-[64px] mb-5 px-4 bg-transparent border border-[oklch(0.55_0_0)] text-[oklch(1_0_0)] placeholder:text-[oklch(0.75_0_0)] outline-none focus:border-[oklch(0.65_0.25_8)]"
          />
          ...
          <textarea
            ...
            value={form.comment}
            onChange={handleChange}
            className="w-full h-[280px] md:h-[360px] p-4 bg-transparent border border-[oklch(0.55_0_0)] text-[oklch(1_0_0)] placeholder:text-[oklch(0.75_0_0)] outline-none resize-none focus:border-[oklch(0.65_0.25_8)]"
          />
          ...
          <div className="flex justify-end mt-4">
            <button
              ...
              className="relative w-[180px] py-4 uppercase tracking-[2px] font-semibold text-[oklch(1_0_0)] hover:text-[oklch(0.65_0.25_8)] transition disabled:opacity-50"
            >
